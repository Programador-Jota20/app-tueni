<?php
    ...
    $Campo   = "Moneda";   // Singular con mayúscula
    $Campos  = "Monedas";  // Plural con mayúscula
    $camp    = "moneda";   // Singular en minúscula
    $camps   = "monedas";  // Plural en minúscula
