...
class Monedas
{
    private static string $campo  = "Moneda";   // singular Mayus
    private static string $campos = "Monedas";  // plural Mayus
    private static string $camp   = "moneda";   // singular minus
    private static string $camps  = "monedas";  // plural minus 
